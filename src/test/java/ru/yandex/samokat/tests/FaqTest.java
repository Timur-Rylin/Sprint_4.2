...
public class FaqTest {
    ...
    private final String expectedFullAnswer;

    public FaqTest(int questionIndex, String expectedFullAnswer) {
        this.questionIndex = questionIndex;
        this.expectedFullAnswer = expectedFullAnswer;
    }
    ...
    public void testFaqAnswer() {
        ...
        assertNotNull("Ответ не должен быть null", actualAnswer);
        assertEquals("Полный текст ответа должен совпадать",
                expectedFullAnswer, actualAnswer);
    }
